            ...
            <form action="{{ route('albums.update', $album->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('titulo') is-invalid @enderror"
                        id="titulo" name="titulo" value="{{ old('titulo', $album->titulo) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('artista') is-invalid @enderror"
                        id="artista" name="artista" value="{{ old('artista', $album->artista) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('genero') is-invalid @enderror"
                        id="genero" name="genero" value="{{ old('genero', $album->genero) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('discografia') is-invalid @enderror"
                        id="discografia" name="discografia" value="{{ old('discografia', $album->discografia) }}">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('formato') is-invalid @enderror" id="formato" name="formato">
                        ...
                        @foreach(['CD', 'Vinilo', 'Cassette', 'Digital'] as $formato)
                            <option value="{{ $formato }}" {{ old('formato', $album->formato) == $formato ? 'selected' : '' }}>{{ $formato }}</option>
                        @endforeach
                    </select>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('anio_publicacion') is-invalid @enderror"
                            id="anio_publicacion" name="anio_publicacion" value="{{ old('anio_publicacion', $album->anio_publicacion) }}" min="1900" max="{{ date('Y') }}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('num_pistas') is-invalid @enderror"
                            id="num_pistas" name="num_pistas" value="{{ old('num_pistas', $album->num_pistas) }}" min="1">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('minutos_duracion') is-invalid @enderror"
                            id="minutos_duracion" name="minutos_duracion" value="{{ old('minutos_duracion', $album->minutos_duracion) }}" min="1">
                ...
                <div class="mb-3">
                    ...
                    @if($album->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $album->image) }}" alt="Portada actual" width="150" class="rounded">
